...
//        console.log("\n");
        ...
        switch (nodeToProcess.nodeType) {
            case Node.ELEMENT_NODE:
                newElmToAppendTo = processElementNodeHtml(nodeToProcess, elmToAppendTo);
                walkHtml(nodeToProcess, newElmToAppendTo);
 ...
 * @returns {Element} the new destination element
 */
